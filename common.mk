...
PRODUCT_COPY_FILES += \
    ...
    ${OUT_DIR}/target/product/fajita/vendor/lib/soundfx/libjamesdsp.so:$(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/lib/soundfx/libjamesdsp.so \
    ${OUT_DIR}/target/product/fajita/vendor/lib64/soundfx/libjamesdsp.so:$(TARGET_COPY_OUT_PRODUCT)/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/lib64/soundfx/libjamesdsp.so
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/permissions/privapp-permissions-oneplus.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/privapp-permissions-oneplus.xml
